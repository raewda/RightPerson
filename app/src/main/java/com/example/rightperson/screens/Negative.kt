...
fun Negative(
    ...
    val negativeItem = remember { mutableStateOf(Negative()) }
    ...
    val newNegative = remember { mutableStateOf(TextFieldValue("")) }
                ...
                Dialog(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            OutlinedTextField(
                                value = newNegative.value,
                                onValueChange = {
                                    newNegative.value = it
                                },
                                modifier = Modifier
                                    .fillMaxWidth(0.9f)
                            ...
                            Button(
                                onClick = {
                                    negativeVM.insertNegative(
                                        Negative(title = newNegative.value.text)
                                    )
                                    dialogAddState.value = false
                                }
                            ) {
